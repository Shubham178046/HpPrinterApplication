...
package com.example.hpprinterapplication.activity;
...
import com.example.hpprinterapplication.R;
import com.example.hpprinterapplication.model.PrintItem;
import com.example.hpprinterapplication.model.PrintJobData;
import com.example.hpprinterapplication.model.PrintMetricsData;
import com.example.hpprinterapplication.util.PrintUtil;
import com.example.hpprinterapplication.util.SnapShotsMediaPrompt;
import com.example.hpprinterapplication.view.PagePreviewView;
...
public class PrintPreview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button button = (Button) findViewById(R.id.print_preview_print_btn);
